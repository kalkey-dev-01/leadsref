    ...
    return (
        <SafeAreaView style={{ backgroundColor: useColorModeValue(colors.lightGray, colors.ebony) }}>
            <View bg={useColorModeValue(colors.lightGray, colors.ebony)} h={'full'} >
                ...
                <Center mt={10}>
                    <Heading bold size={'2xl'}>leadsRef</Heading>
                </Center>
                <Center mx={'10'} mt={'1.5'}>
                ...
                <TouchableOpacity onPress={() => nav.navigate('register' as never)}>
                    <Center mx={'5'} mt={'5'}>
                        <HStack alignItems={'center'} space={'1.5'} bg={colors.gray} rounded={'full'} pl={'3.5'}>
                            ...
                            <Button rounded={'full'} size={'sm'} color={colors.gray} variant={'solid'} bgColor={colors.coolGray}>Sign in with Email and Password</Button>
                        </HStack>
                    </Center>
                </TouchableOpacity>
